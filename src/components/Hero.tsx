    ...
    <section className="pt-6 pb-0 bg-white overflow-hidden">
        ...
        <div className="text-center mb-6">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
            ...
            <a href={DEMO_URL} target="_blank"
              className="px-10 py-4 rounded-full bg-[#d66501] text-white text-base font-medium hover:bg-[#bf5a01] transition-all duration-200 shadow-[0_4px_16px_rgba(214,101,1,0.3)] hover:scale-[1.02]">
              Скачать
            </a>
          </motion.div>
        </div>
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
        ...
        <div className="flex flex-col md:flex-row md:items-start gap-6 md:gap-10">
          ...
          <a href={DEMO_URL} target="_blank"
            className="flex-shrink-0 px-10 py-4 rounded-full bg-[#d66501] text-white text-base font-medium hover:bg-[#bf5a01] transition-all duration-200 shadow-[0_4px_16px_rgba(214,101,1,0.3)] hover:scale-[1.02] self-start">
            Скачать
          </a>
        </div>
      </motion.div>
