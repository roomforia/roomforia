        ...
        <div className="grid md:grid-cols-2 gap-10 md:gap-24 items-start">
          ...
          <div>
            ...
            <a
              ...
              target="_blank"
              className="mt-4 inline-flex px-10 py-4 rounded-full bg-[#d66501] text-white text-base font-medium hover:bg-[#bf5a01] transition-all duration-200 shadow-[0_4px_16px_rgba(214,101,1,0.3)] hover:scale-[1.02]"
            >
              Скачать
            </a>
          </div>
