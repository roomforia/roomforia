        ...
        <div className="grid md:grid-cols-2 gap-10 md:gap-24 items-center">
          ...
          <div>
            ...
            <div className="md:hidden mb-6">
              <p className="text-[32px] font-semibold tracking-tight text-[#1E1E1E] leading-[1.1]">Мы не продаём</p>
              <p className="text-[32px] font-semibold tracking-tight text-[#d66501] leading-[1.1]">технологии</p>
            </div>
            {/* Десктоп */}
            <div className="hidden md:block">
              <div className="flex items-end flex-wrap overflow-hidden mb-1">
                {"Мы не продаём".split("").map((char, i) => (
                  <motion.span key={i}
          ...
          <motion.div
            ...
            className="relative rounded-3xl bg-[#111] overflow-hidden p-8 md:p-14"
          >
            ...
            <div className="relative">
              ...
              <p className="text-white text-xl md:text-3xl font-semibold leading-snug mb-8">
