      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        ...
        <div className="mb-10 md:mb-16">
          ...
          <div className="md:hidden mb-2">
            <p className="text-[32px] font-semibold tracking-tight text-[#1E1E1E] leading-[1.1]">Единая экосистема</p>
          </div>
          {/* Десктоп */}
          <div className="hidden md:block mb-4">
            <div className="flex items-end flex-wrap overflow-hidden">
              {"Единая экосистема".split("").map((char, i) => (
                <motion.span key={i}
            ...
            >
              ...
              <div className="p-5 md:p-6">
                <div className="flex items-center gap-2 mb-2 md:mb-3">
                  ...
                  <h3 className="font-semibold text-base md:text-lg text-[#1E1E1E]">{item.title}</h3>
                </div>
