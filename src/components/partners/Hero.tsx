      ...
      <section className="pt-20 pb-0 bg-white overflow-hidden">
          ...
          <div className="text-center mb-8 pt-8">
            ...
            <div className="hidden md:block">
              <div className="flex items-end justify-center flex-wrap mb-1 min-h-[90px]">
                {line1.map((char, i) => (
                  <motion.span key={i} initial={{ opacity: 0, x: -16, filter: "blur(12px)" }} animate={{ opacity: 1, x: 0, filter: "blur(0px)" }}
            ...
            <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
              ...
              Мы интегрируем ваш каталог в AI-дизайн. Пользователь видит товар в интерьере — переходит — покупает у вас
            </motion.p>
        ...
        <motion.div initial={{ opacity: 0, y: 60 }} animate={{ opacity: 1, y: 0 }}
          ...
          <div className="relative w-full h-[280px] md:h-[580px] rounded-3xl overflow-hidden shadow-[0_32px_80px_rgba(0,0,0,0.12)]">
            {/* priority — первый экран страницы /partners */}
            <Image src="/images/hero/room-real.png" alt="Интерьер" fill className="object-cover" priority sizes="100vw" />
