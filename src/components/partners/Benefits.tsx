  ...
  return (
    <section className="py-10 md:py-16 px-4 md:px-8 bg-white">
      ...
      >
        ...
        <div className="relative px-6 md:px-16 py-10 md:py-20">
          ...
          <div className="grid md:grid-cols-3 gap-0">
            {stats.map((item, i) => (
              <motion.div
                ...
                className="group relative py-6 md:py-0"
              >
                {i > 0 && (
                  <div className="hidden md:block absolute left-0 top-0 bottom-0 w-[1px] bg-white/10" />
                )}
                {i > 0 && (
                  <div className="md:hidden h-[1px] bg-white/10 mb-6" />
                )}
                <div className="md:px-12">
                  <div
                    className="text-4xl md:text-6xl font-semibold mb-2 md:mb-3 leading-none"
                    style={{ color: i % 2 === 0 ? "#855dda" : "#d66501" }}
                  >
                    {item.num}
                  </div>
                  <div className="text-white font-medium text-base md:text-lg mb-1 md:mb-2">{item.label}</div>
          ...
          <div className="mt-8 md:mt-14 h-[1px] bg-white/10" />
          <p className="mt-4 md:mt-6 text-white/25 text-xs">
